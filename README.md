...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.shamodhas/jwt-security-spring-boot-starter)](https://central.sonatype.com/artifact/io.github.shamodhas/jwt-security-spring-boot-starter)
...
The library is published on **Maven Central**. Just add the dependency — no local install or extra repositories needed.
...
This installs the artifact into your local `~/.m2` repository under the same coordinates above.
...
```java
package com.shamodha.jwtsecurityspringbootstarter.spi;
